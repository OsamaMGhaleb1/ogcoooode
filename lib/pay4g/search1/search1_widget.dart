          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Divider(
                  thickness: 2.0,
                  color: Color(0xFF0BADFF),
                ),
                StreamBuilder<List<ShahnRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<ShahnRecord> listViewShahnRecordList = snapshot.data!;
                    if (listViewShahnRecordList.isEmpty) {
                      return Image.asset(
                        'assets/images/FAQIH_MOBILE_(2).png',
                      );
                    }
                    final listViewShahnRecord =
                        listViewShahnRecordList.isNotEmpty
                            ? listViewShahnRecordList.first
                            : null;
