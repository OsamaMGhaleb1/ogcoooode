...
import 'networkraseeadsl_model.dart';
export 'networkraseeadsl_model.dart';

class NetworkraseeadslWidget extends StatefulWidget {
  const NetworkraseeadslWidget({
    super.key,
    required this.name,
    this.type,
  });
  ...
  @override
  State<NetworkraseeadslWidget> createState() => _NetworkraseeadslWidgetState();
}

class _NetworkraseeadslWidgetState extends State<NetworkraseeadslWidget>
    with TickerProviderStateMixin {
  late NetworkraseeadslModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NetworkraseeadslModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final networkraseeadslPaymentMessageResponse = snapshot.data!;
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: FutureBuilder<
                                                      ...
                                                      builder:
                                                        ...
                                                        final textFieldQuerySubscriberBalanceMessageResponse =
                                                            snapshot.data!;
                                                            ...
                                                            controller: _model
                                                              ...
                                                              text:
                                                                  valueOrDefault<
                                                                      String>(
                                                                getJsonField(
                                                                  textFieldQuerySubscriberBalanceMessageResponse
                                                                      .jsonBody,
                                                                  r'''$.BAL''',
                                                                )?.toString(),
                                                                '300',
                                                                            ...
                                                                            decoration:
                                                                              ...
                                                                              border: Border.all(
                                                                                color: valueOrDefault<Color>(
                                                                                  _model.query == 10 ? FlutterFlowTheme.of(context).primary : FlutterFlowTheme.of(context).primaryBackground,
                                                                                  ...
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: Text(
                                                                                      FFLocalizations.of(context).getText(
                                                                                        'exxd7vhe' /* باقات الإنترنت المنزلي */,
                                                                                      ),
                                                                                      textAlign: TextAlign.center,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              List<AdslRecord> listViewAdslRecordList = snapshot.data!;
                                                                              ...
                                                                              return ListView.builder(
                                                                                ...
                                                                                itemCount: listViewAdslRecordList.length,
                                                                                itemBuilder: (context, listViewIndex) {
                                                                                  final listViewAdslRecord = listViewAdslRecordList[listViewIndex];
                                                                                  return Material(
                                                                                    ...
                                                                                    child: Theme(
                                                                                      ...
                                                                                      child: CheckboxListTile(
                                                                                        value: _model.checkboxListTileValueMap[listViewAdslRecord] ??= false,
                                                                                        onChanged: (newValue) async {
                                                                                          safeSetState(() => _model.checkboxListTileValueMap[listViewAdslRecord] = newValue!);
                                                                                          if (newValue!) {
                                                                                            safeSetState(() {
                                                                                              _model.nameTextController?.text = listViewAdslRecord.name;
                                                                                            });
                                                                                            safeSetState(() {
                                                                                              _model.acTextController?.text = '7200';
                                                                                            });
                                                                                            safeSetState(() {
                                                                                              _model.costTextController?.text = listViewAdslRecord.cost.toString();
                                                                                            });
                                                                                            safeSetState(() {
                                                                                              _model.sacTextController?.text = listViewAdslRecord.id;
                                                                                            });
                                                                                            safeSetState(() {
                                                                                              _model.amtTextController?.text = listViewAdslRecord.price.toString();
                                                                                            });
                                                                                          } else {
                                                                                            safeSetState(() {
