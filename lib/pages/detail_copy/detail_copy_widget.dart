...
import 'detail_copy_model.dart';
export 'detail_copy_model.dart';
...
class DetailCopyWidget extends StatefulWidget {
  ...
  @override
  State<DetailCopyWidget> createState() => _DetailCopyWidgetState();
}

class _DetailCopyWidgetState extends State<DetailCopyWidget> {
  late DetailCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailCopyModel());
                            ...
                            return ListView.separated(
                              ...
                              itemBuilder: (context, listViewIndex) {
                                ...
                                return Padding(
                                  ...
                                  child: ReviewWidget(
                                    key: Key(
                                        'Key4a3_${listViewIndex}_of_${listViewReviewRecordList.length}'),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: FFButtonWidget(
                                onPressed: () async {
                                  if (_model.countControllerValue != null) {
