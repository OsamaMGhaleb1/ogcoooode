...
class UsersRecord extends FirestoreRecord {
  ...
  // "SALDOYE" field.
  double? _saldoye;
  double get saldoye => _saldoye ?? 0.0;
  bool hasSaldoye() => _saldoye != null;
  ...
  // "shahnrasid" field.
  DocumentReference? _shahnrasid;
  DocumentReference? get shahnrasid => _shahnrasid;
  bool hasShahnrasid() => _shahnrasid != null;
  ...
  void _initializeFields() {
    ...
    _saldoye = castToType<double>(snapshotData['SALDOYE']);
    _order = snapshotData['ORDER'] as DocumentReference?;
    _shahnrasid = snapshotData['shahnrasid'] as DocumentReference?;
  }
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    ...
    return e1?.email == e2?.email &&
        ...
        e1?.saldo == e2?.saldo &&
        e1?.dni == e2?.dni &&
        e1?.saldoye == e2?.saldoye &&
        e1?.order == e2?.order &&
        e1?.shahnrasid == e2?.shahnrasid;
  }
