...
class CartProductStruct extends FFFirebaseStruct {
  ...
  // "sd" field.
  List<String>? _sd;
  List<String> get sd => _sd ?? const [];
  set sd(List<String>? val) => _sd = val;

  void updateSd(Function(List<String>) updateFn) {
    updateFn(_sd ??= []);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is CartProductStruct &&
        ...
        size == other.size &&
        count == other.count &&
        listEquality.equals(sd, other.sd);
  }

  @override
  int get hashCode => const ListEquality()
      .hash([productRef, name, image, price, color, size, count, sd]);
}
