...
import 'sendmonyemen_model.dart';
export 'sendmonyemen_model.dart';

class SendmonyemenWidget extends StatefulWidget {
  const SendmonyemenWidget({super.key});

  @override
  State<SendmonyemenWidget> createState() => _SendmonyemenWidgetState();
}

class _SendmonyemenWidgetState extends State<SendmonyemenWidget> {
  late SendmonyemenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SendmonyemenModel());
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                                ...
                                child: Align(
                                  ...
                                  child: FlutterFlowChoiceChips(
                                    options: [
                                      ...
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                            '4b4es39l' /* phone number */,
                                          ),
                                          Icons.phone_iphone),
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        'bvenowdn' /* ID card number */,
                                      ))
                                    ],
                        ...
                        if (_model.choiceChipsValue == 'البريد الإلكتروني')
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 25.0, 0.0, 0.0),
                        ...
                        if (_model.choiceChipsValue == 'رقم الهاتف')
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 25.0, 0.0, 0.0),
                            child: StreamBuilder<List<UsersRecord>>(
                        ...
                        if (_model.choiceChipsValue == 'رقم بطاقة الهوية')
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 25.0, 0.0, 0.0),
                            child: StreamBuilder<List<UsersRecord>>(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'ct923ep9' /* Agregar nota (opcional) */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                        ...
                                        if (valueOrDefault(
                                          ...
                                          await pagosRecordReference.set({
                                            ...createPagosRecordData(
                                              cantidad: double.tryParse(_model
                                                  .amountTextController.text),
