...
import 'serviceraseed_model.dart';
export 'serviceraseed_model.dart';

class ServiceraseedWidget extends StatefulWidget {
  const ServiceraseedWidget({super.key});

  @override
  State<ServiceraseedWidget> createState() => _ServiceraseedWidgetState();
}

class _ServiceraseedWidgetState extends State<ServiceraseedWidget> {
  late ServiceraseedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ServiceraseedModel());
  }
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    fit: BoxFit.cover,
                                    image: Image.asset(
                                      'assets/images/pngtree-water-meter-icon-cartoon-style-png-image_1923916.jpg',
                                    ).image,
                                  ),
                                  borderRadius: BorderRadius.circular(16.0),
                                ),
